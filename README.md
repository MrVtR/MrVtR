...
# :rocket: Sobre mim
<p align="left"> 
  Olá, me chamo Vítor Ribeiro, tenho 22 anos e sou graduado em Ciência da Computação pela UFSCar-Sorocaba. Conto com experiência sólida na área de Ciência de Dados, além de ter habilidades avançadas em inglês. Em 2020, iniciei meus estudos na área de Dados e participei da prestigiosa maratona Behind the Code promovida pela IBM, onde fiquei entre os 200 melhores do Brasil, com mais de 70 mil inscritos. Recentemente recebi uma bolsa de estudos fornecida pela empresa Google através de um processo seletivo para seu curso extensivo de Análise de Dados Profissional.</p>
 <p>
Demonstro um forte interesse em trabalhar no mercado de desenvolvimento tecnológico, focando especialmente na área de <b>Engenharia/Ciência de Dados</b> e Computação em Nuvem. Meu objetivo é criar e aplicar soluções inovadoras com potencial para ter um impacto global significativo. Tenho afinidade com plataformas como Google Cloud, Azure e AWS, bem como com as tecnologias Python e Jupyter Notebook, pois são nesses pontos que meus interesses se convergem.
</p>
<p>
